...
def test_add_comment(test_post_id, test_user_id):
    ...
    response = requests.post(f"{BASE_URL}/posts/{test_post_id}/comments", json=comment_data)
...
def test_delete_comment(test_post_id, test_user_id):
    ...
    add_response = requests.post(f"{BASE_URL}/posts/{test_post_id}/comments", json=comment_data)
    assert add_response.status_code == 201
    comment_id = add_response.json()["commentId"]

    # Delete the comment
    delete_data = {"user_id": test_user_id}
    response = requests.delete(f"{BASE_URL}/posts/{test_post_id}/comments/{comment_id}", json=delete_data)
    ...
    post_response = requests.get(f"{BASE_URL}/posts/{test_post_id}")
...
def test_delete_comment_nonexistent(test_post_id, test_user_id):
    ...
    delete_data = {"user_id": test_user_id}
    response = requests.delete(f"{BASE_URL}/posts/{test_post_id}/comments/9999", json=delete_data)
